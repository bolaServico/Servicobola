      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <div className="flex flex-col sm:flex-row gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="btn-secondary flex items-center justify-center space-x-3 px-6 py-4 rounded-2xl"
              >
        ...
        >
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="btn-accent px-12 py-6 rounded-full text-xl inline-flex items-center space-x-3"
          >
            <Download size={24} />
